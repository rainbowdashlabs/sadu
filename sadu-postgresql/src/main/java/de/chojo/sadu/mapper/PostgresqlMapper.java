...
import static de.chojo.sadu.types.PostgreSqlTypes.JSON;
import static de.chojo.sadu.types.PostgreSqlTypes.JSONB;
import static de.chojo.sadu.types.PostgreSqlTypes.NUMERIC;
import static de.chojo.sadu.types.PostgreSqlTypes.REAL;
...
public final class PostgresqlMapper {
    ...
    public static final RowMapper<Short> SHORT_MAPPER = createShort(List.of(SMALLINT, INTEGER));
    ...
    public static final RowMapper<Double> DOUBLE_MAPPER = createDouble(List.of(DECIMAL, NUMERIC, DOUBLE, REAL));
    public static final RowMapper<BigDecimal> BIG_DECIMAL_MAPPER = createBigDecimal(List.of(DECIMAL, NUMERIC, DOUBLE, REAL));
    public static final RowMapper<String> STRING_MAPPER = createString(List.of(TEXT, VARCHAR, CHAR, JSON, JSONB));
