...
import static de.chojo.sadu.types.MariaDbTypes.CHAR;
...
public final class MariaDbMapper {
    ...
    public static final RowMapper<Short> SHORT_MAPPER = createShort(List.of(TINYINT, SMALLINT));
    ...
    public static final RowMapper<Float> FLOAT_MAPPER = createFloat(List.of(FLOAT));
    public static final RowMapper<Double> DOUBLE_MAPPER = createDouble(List.of(DOUBLE));
    public static final RowMapper<BigDecimal> BIG_DECIMAL_MAPPER = createBigDecimal(List.of(DECIMAL));
    public static final RowMapper<String> STRING_MAPPER = createString(List.of(TINYTEXT, TEXT, MEDIUMTEXT, LONGTEXT, VARCHAR, CHAR));
